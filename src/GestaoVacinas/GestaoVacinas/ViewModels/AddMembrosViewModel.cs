...
namespace GestaoVacinas.ViewModels
{
    public class AddMembrosViewModel
    {
        ...
        [StringLength(maximumLength: 30, MinimumLength = 2, ErrorMessage = "O apelido deverá conter entre 2 e 30 caracteres.")]
        public string Apelido { get; set; }

        [Display(Name = "Nome Completo")]
        [Required(ErrorMessage = "O nome completo é obrigatório.")]
        [StringLength(maximumLength: 50, MinimumLength = 5, ErrorMessage = "O nome completo deverá conter entre 5 e 50 caracteres.")]
